...
export const CollectionIcon = () => {
    return (
        <svg className='sideBarIcon' viewBox="0 0 512 512" width="24" height="24" xmlns="http://www.w3.org/2000/svg">
          <path className='libraryIcon' d="M291.301 81.778l166.349 373.587-19.301 8.635-166.349-373.587zM64 463.746v-384h21.334v384h-21.334zM192 463.746v-384h21.334v384h-21.334z" fill="currentColor"></path>
        </svg>
    )   
}
...
export const ClockIcon = () => {
    return (
        <svg className='timeIcon' width="16" height="16" viewBox="0 0 16 16" fill="none">
...
export const ShuffleIcon = ({ state, updateState }) => {
    return (
        <div>
          <svg className='shuffle' role="img" height="16" width="16" viewBox="0 0 16 16" onClick={()=> updateState(!state)}>
            <path className={state? 'shuffleActive' : 'shuffleIcon'} d="M4.5 6.8l.7-.8C4.1 4.7 2.5 4 .9 4v1c1.3 0 2.6.6 3.5 1.6l.1.2zm7.5 4.7c-1.2 0-2.3-.5-3.2-1.3l-.6.8c1 1 2.4 1.5 3.8 1.5V14l3.5-2-3.5-2v1.5zm0-6V7l3.5-2L12 3v1.5c-1.6 0-3.2.7-4.2 2l-3.4 3.9c-.9 1-2.2 1.6-3.5 1.6v1c1.6 0 3.2-.7 4.2-2l3.4-3.9c.9-1 2.2-1.6 3.5-1.6z"></path>
          </svg>
          <div className='circle' style={state? {visibility: 'visible'} : {}}/>
        </div>
    )
}