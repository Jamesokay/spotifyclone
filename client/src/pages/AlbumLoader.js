           ...
           <tr>
             ...
             <td className='emptyCell'></td>
               ...
               <td className='rowFirst tdRegTrack'>
                 <div className='skeletonIndex'></div>
               </td>
              
               <td className='tdRegTrack'>
                 <div className='skeletonTitle' style={{width: '25%'}}></div>                     
                   <div className='skeletonArtist' style={{width: '15%'}}></div>                
               </td>
               <td></td>
               <td className='tdRegTrack'><div className='skeletonTime'></div></td>
